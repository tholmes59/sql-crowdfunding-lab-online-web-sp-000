...
"SELECT projects.title, pledges.amount-projects.funding_goal FROM projects INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY title HAVING SUM(pledges.amount) >= projects.funding_goal;"
end
