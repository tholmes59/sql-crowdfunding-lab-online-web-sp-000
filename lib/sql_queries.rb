...
"SELECT projects.title, pledges.amount-projects.funding_goal AS Difference FROM projects INNER JOIN pledges ON projects.id = pledges.project_id WHERE pledges.amount >= projects.funding_goal;"
end
