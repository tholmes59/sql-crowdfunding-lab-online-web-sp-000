...
"SELECT projects.title, (pledges.amount-projects.funding_goal) AS Difference FROM projects INNER JOIN pledges ON projects.id = pledges.project_id WHERE SUM(pledges.amount) >= projects.funding_goal GROUP BY title;"
end
