...
"SELECT projects.title, projects.funding_goal-pledges.amount AS Difference FROM projects INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY title HAVING SUM(pledges.amount) >= projects.funding_goal;"
end
